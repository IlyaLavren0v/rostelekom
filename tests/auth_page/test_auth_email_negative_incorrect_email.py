...
class TestAuthEmailNegative(unittest.TestCase):
    ...
    def test_negative_email_authentication_incorrect_email(self):
        """Негативная авторизация по почте с некорректным адресом"""
        self.auth_page.enter_email("incorrect_email@example.com")
